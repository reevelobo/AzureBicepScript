...
az deployment group create --subscription insomnia --resource-group bicep-course --name deployment --template-file main.bicep --parameters storageAccountName=mystorageaccount storageAccountType=Standard_LRS